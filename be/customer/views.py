...
class ListCustomerView(APIView):
    def get(self, request, format=None):
        person = Customer.objects.using("postgresql").all()
    ...
    def post(self, request):
        ...
        try:
            customercheck = Customer.objects.using("postgresql").get(
            ...
            if customercheck:
                ...
                customer = Customer.objects.using("postgresql").create()
...
class DetailCustomer(APIView):
    def delete(self, request, id):
        try:
            customer = Customer.objects.using("postgresql").get(id=id)
            customer.delete()
...
class LoginCustomer(APIView):
    def post(self, request):
        ...
        try:
            cus = Customer.objects.using("postgresql").get(username=username)
